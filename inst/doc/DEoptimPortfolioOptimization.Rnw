...
Katharine M. Mullen \\ NIST \And Brian G. Peterson \\ Cheiron Trading}
...
\citet{ArdiaBoudtCarlMullenPeterson2010}; namely minimizing 
...
described 
\cite{ArdiaBoudtCarlMullenPeterson2010}, but expand the problem 
to include 100 free variables.  As in
\citet{ArdiaBoudtCarlMullenPeterson2010}, the portfolio CVaR is
...
\citet{ArdiaBoudtCarlMullenPeterson2010} was stylized to describe many
...
simple case considered by \citet{ArdiaBoudtCarlMullenPeterson2010},
